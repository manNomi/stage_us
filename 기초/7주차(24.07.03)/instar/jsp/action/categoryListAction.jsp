...
<%! 
// 회원가입 메소드
public String tryListSet(Connection connection, String categoryName,String userIdx) {
    String errorMessage = "";
    try {
        // 사용자 데이터 삽입 시도
        String joinSQL = "INSERT INTO PostList (post_list_name , user_idx ) VALUES (?,?)";
...
<%
    ...
    String errorMessage = tryListSet(connection,categoryName,userId);
...
<script>
    ...
    if (errorMessage === "") {
        alert(categoryName+ " 추가되었습니다"); // errorMessage를 알림창으로 표시
