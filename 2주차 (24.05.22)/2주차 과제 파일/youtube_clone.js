...
search_btn.onclick=function(){
  ...
  document.location.href="https://www.youtube.com/results?search_query="+search_btn_text.value;
}
...
window.onload=function(){
  ...
  for(i=0;i<thumb_index;i++){
    thumb_img.push("image/png/main.play_img.PNG")
    thumb_userImg.push("image/png/main.playname_img.PNG")
    thumb_title.push("𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭 돌아가고 싶은 그때 그 시절 2010년 감성힙합 I 다이나믹듀오, 프라이머리, 긱스, 개리, 빈지노")
